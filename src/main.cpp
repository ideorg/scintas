...
void MyFrame::CreateMenu() {
    ...
    wxMenuItem *edit_cut = new wxMenuItem(menuEdit, wxID_CUT, "Cut\tCtrl-X", "");
    menuEdit->Append(edit_cut);
    wxMenuItem *edit_copy = new wxMenuItem(menuEdit, wxID_COPY, "Copy\tCtrl-C", "");
    menuEdit->Append(edit_copy);
    wxMenuItem *edit_paste = new wxMenuItem(menuEdit, wxID_PASTE, "Paste\tCtrl-V", "");
    menuEdit->Append(edit_paste);
    wxMenuItem *edit_delete = new wxMenuItem(menuEdit, wxID_DELETE, "Delete", "");
    menuEdit->Append(edit_delete);
    wxMenuItem *edit_selectAll = new wxMenuItem(menuEdit, wxID_SELECTALL, "Select all\tCtrl+A", "");
    menuEdit->Append(edit_selectAll);
    wxMenuItem *edit_selectWord = new wxMenuItem(menuEdit, wxxID_SelectWord, "Select word\tCtrl+W", "");
    menuEdit->Append(edit_selectWord);
    wxMenuItem *edit_selectMode = new wxMenuItem(menuEdit, wxID_ANY, "Select mode", "");
    menuEdit->Append(edit_selectMode);
    wxMenuItem *edit_changeCase = new wxMenuItem(menuEdit, wxID_ANY, "Change case", "");
    wxMenu *menuChangeCase = new wxMenu;
    edit_changeCase->SetSubMenu(menuChangeCase);
    wxMenuItem *edit_changeCaseUpper = new wxMenuItem(menuEdit, wxxID_ChangeCaseUpper, "Upper\tCtrl-U", "");
    menuChangeCase->Append(edit_changeCaseUpper);
    wxMenuItem *edit_changeCaseLower = new wxMenuItem(menuEdit, wxxID_ChangeCaseLower, "Lower\tCtrl-L", "");
